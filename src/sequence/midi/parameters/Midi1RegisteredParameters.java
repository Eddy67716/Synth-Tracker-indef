 ...
 * @author eddy6
 */
public class Midi1RegisteredParameters extends RegisteredParameters {

    // instance variables
    // hammond organ RPN accumulators
    private final short[] drawbarOrganEventAccumulators;
    // rotary accumulators
    private final short[] rotaryEventAccumulators;

    public Midi1RegisteredParameters() {
        drawbarOrganEventAccumulators = new short[DRAWBAR_LENGTH];
        rotaryEventAccumulators = new short[ROTARY_LENGTH];
    }
