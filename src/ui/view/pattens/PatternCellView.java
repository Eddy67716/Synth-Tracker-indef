 ...
 */
public class PatternCellView extends JPanel implements TableCellRenderer {
    ...
    // constructor
    public PatternCellView(int modType, short instrumentCount) {
    ...
    private void initCell(JTextField field) {
        ...
        field.setBackground(UIProperties.getTableBackgroundColour());
    ...
    public Component getTableCellRendererComponent(JTable table, Object value,
        ...
        if (isSelected) {
            reColourCell(UIProperties.getWashedShadowColour());
        } else if (hasFocus) {
            reColourCell(UIProperties.getWashedShadowColour());
        } else if (row % hilightValues[1] == 0) {
            reColourCell(UIProperties.getHeavilyWashedColour());
        } else if (row % hilightValues[0] == 0) {
            reColourCell(UIProperties.getExtremelyWashedColour());
        } else {
            reColourCell(UIProperties.getTableBackgroundColour());
        }
