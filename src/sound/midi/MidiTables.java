...
public class MidiTables {
    ...
    public static final String[] DRUM_NAMES = {
        ...
        "Vibraslap", "Ride cymbal 2", "High bongo", "Low bongo", 
        ...
        "High wood block", "Low wood blocks", "Mute cuica", "Open cuica", 
        "Mute Triangle", "Open Triangle", "Shaker", "Jingle bell", "Bell tree", 
